...
def _build_graph():
    ...
    g.set_entry_point("generator_node")
    g.add_edge("generator_node", "conservator_node")
    g.add_edge("conservator_node", "control_node")
...
def run_langgraph(inp: DeliberationInput) -> Report:
    """Run the Generator→Conservator→Control pipeline as a LangGraph StateGraph."""
